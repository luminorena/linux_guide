...
метром -A. Этот сценарий создает пять таких массивов:  <br>
1. files хранит имена файлов, найденных в каталоге, индексируется именами
файлов.  <br>
2. file_group хранит имена групп, владеющих файлами, индексируется именами
файлов.  <br>
3. file_owner хранит имена пользователей, владеющих файлами, индексируется именами файлов.  <br>
4. groups хранит число файлов, принадлежащих каждой группе, индексируется именами групп. <br>
5. owners хранит число файлов, принадлежащих каждому пользователю, индексируется именами пользователей. <br>
* Строки 7–10: эти строки проверяют имя каталога, переданное в позиционном параметре. Если каталог с указанным именем не существует, выводится сообщение,
описывающее порядок использования сценария, после чего сценарий завершается с кодом 1.
