...
Команда cat позволяет прочитать содержимое одного или более файлов и скопировать его в стандартный вывод. Для начала разобьем архив на части с помощью команды
